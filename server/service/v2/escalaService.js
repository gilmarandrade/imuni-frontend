...
module.exports = app => {
    ...
    /**
     * Extração de valores das respostas
     */
    ...
    return { riscoContagioEnum, vulnerabilidadeEnum, epidemiologicaEnum, calcularEscalas, calcularEscalaVulnerabilidade, calculaEscalaEpidemiologica, calcularEscalaRiscoContagio, calcularDataProximoAtendimento, extractResponse, extractNumber, extractBoolean, isEquals, isNotEquals, extractRequiredList }
};