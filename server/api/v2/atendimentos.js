        ...
        try {
            ...
            if(atendimento && atendimento.responses) {
                ...
                atendimento.responses.forEach(item => {
                    atendimento.items[item.question.substring(1,4)] = {};
                });

                atendimento.responses.forEach(item => {
                    atendimento.items[item.question.substring(1,4)][item.question.substring(4,7)] = item;
                });

                console.log(atendimento.items);
